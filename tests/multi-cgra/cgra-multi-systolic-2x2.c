...
int main(void) {
  ...
  cgra_send_packets_fast(CGRA_MULTI_SYSTOLIC_2X2_PRELOAD_PACKETS,
                         CGRA_MULTI_SYSTOLIC_2X2_PRELOAD_PACKET_COUNT);

  printf("Configuring and launching systolic CGRAs...\n");
  cgra_send_packets_fast(CGRA_MULTI_SYSTOLIC_2X2_CONFIG_PACKETS,
                         CGRA_MULTI_SYSTOLIC_2X2_CONFIG_PACKET_COUNT);
  cgra_send_packets_fast(CGRA_MULTI_SYSTOLIC_2X2_LAUNCH_PACKETS,
                         CGRA_MULTI_SYSTOLIC_2X2_LAUNCH_PACKET_COUNT);
  ...
  uint64_t v3 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[0]);
  uint64_t v4 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[1]);
  uint64_t v5 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[2]);
  uint64_t v32 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[3]);
  uint64_t v33 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[4]);
  uint64_t v34 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[5]);
  uint64_t v35 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[6]);
  uint64_t v36 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[7]);
  uint64_t v37 =
      load_result_from_packet(CGRA_MULTI_SYSTOLIC_2X2_READBACK_PACKETS[8]);
